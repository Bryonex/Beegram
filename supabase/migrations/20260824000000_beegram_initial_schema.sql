-- Beegram Database Migration: Initial Schema
-- This schema establishes the core architecture for the private relationship app.
-- It ensures data is fully private to authenticated users and supports username login.
